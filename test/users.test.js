...
describe('User Routes', function(){
  ...
  describe('authenticate', function(){
    it('should return a token when the user is authenticated', function(done){
      var user = { auth: { email: faker.internet.email(), password: faker.internet.password() } };
  ...
  describe('create', function(){
    it('should create a user', function(done){
      var user = { auth: { email: 'test@test.com', password: 'testing', profile_id: 1, profile_type: 'Candidate',
